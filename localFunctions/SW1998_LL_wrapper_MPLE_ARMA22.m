function [negLL, struct_out] = SW1998_LL_wrapper_MPLE_ARMA22(starting_values, data_input, other_inputs, KFS_on)
...
% ---------------------------------------------------------------------------------------------
% NOTE: P00(1,1) stays at 0 as in SW(1998) (see the files lnair1.prc lnair2.prc
% ---------------------------------------------------------------------------------------------
